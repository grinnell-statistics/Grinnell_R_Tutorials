...
```{r}
collegeAdm = read.csv("https://raw.githubusercontent.com/grinnell-statistics/Grinnell_R_Tutorials/refs/heads/main/data/college_adm.csv")
```
...
```{r}
bluechips = read.csv("https://raw.githubusercontent.com/grinnell-statistics/Grinnell_R_Tutorials/refs/heads/main/data/bluechips.csv")
```
...
```{r}
polls <- read.csv("https://raw.githubusercontent.com/grinnell-statistics/Grinnell_R_Tutorials/refs/heads/main/data/polls2016.csv")
```
